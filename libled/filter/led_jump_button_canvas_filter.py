...
import time
import random
from ..util.hw_controller_manager import HwControllerManager
...
class LedJumpButtonCanvasFilter(LedCanvasFilter):
    ...
    def __init__(self, canvas):
        ...
        self.power = 0
        self.push = 0
        HwControllerManager.add_observer(self)

    def destructer(self):
        super(LedJumpButtonCanvasFilter, self).destructer()
        HwControllerManager.remove_observer(self)
